...
import { gdsApplicationBase } from './base';
...
const GraphStoreCatalogBase = gdsApplicationBase(GdsGraphStoreCatalogFacadeSchema);
...
export const StreamRelationshipPropertiesCallSchema = GraphStoreCatalogBase.extend({
...
export const SampleRandomWalkWithRestartsCallSchema = GraphStoreCatalogBase.extend({
...
export const SampleCommonNeighbourAwareRandomWalkCallSchema = GraphStoreCatalogBase.extend({
