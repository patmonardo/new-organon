  ...
  const batch = [
    {
      ...
      snapshot: {
        nodes: [0, 1, 2],
        relationships: [
          { type: 'KNOWS', source: 0, target: 1, properties: { weight: 1.5, hops: 1 } },
          { type: 'KNOWS', source: 1, target: 2, properties: { weight: 2.25, hops: 2 } },
          { type: 'LIKES', source: 0, target: 2, properties: { weight: 0.5, hops: 1 } },
        ],
      },
    },
    {
