\section*{Overview of Transcendental Philosophy}

\subsection*{Part I. Truth, Oneness, and the Absolute}

\paragraph{Thesis 1 (Truth).}
...
\paragraph{Exclusion.}
We will not allow to count as truth that in which things can be this way
or equally well the other (e.g., the multiplicity and variability of opinions).

\paragraph{Definition 1 (Truth).}
Truth is absolute oneness and invariableness of opinion.

\paragraph{Thesis 2 (Task of philosophy).}
...
\paragraph{Definition 2 (Oneness).}
Absolute oneness is what is true and in itself unchangeable,
its opposite contained purely within itself.

\paragraph{Thesis 3 (Reciprocity).}
The task is to reciprocally conceive multiplicity through oneness and oneness
through multiplicity.

\paragraph{Notation.}
As a principle, Oneness (= $A$) illuminates such multiplicity,
and conversely multiplicity in its ontological ground can be grasped only by
proceeding from $A$.

\paragraph{Thesis 4 (Principle of systems).}
The difference in all philosophical systems can only reside in their principle of
oneness: the one true self-contained in-itself.

\paragraph{Thesis 5 (Uniqueness).}
If one principle alone is right and true, then only one philosophy is true.

\paragraph{Historical claim.}
In all philosophies prior to Kant, the absolute was located in being.

\paragraph{Corollary 1 (Refutation of subordinate oneness).}
Since there is only one absolute, a philosophy which has not made this one true
absolute its own doesn't have the absolute at all but only something relative:
a product of an unperceived disjunction, which for this reason must have an
opposing term. Such a philosophy leads all multiplicity back, not to absolute
oneness as the task requires, but only to a subordinate, relative oneness, and
thus it is refuted.

\subsection*{Part II. Disjunction of Being and Thinking}

\paragraph{Thesis 6 (Disjunction).}
Absolutely all being posits a thinking or consciousness of itself.
Therefore mere being is one half of a whole together with the thought of it,
and is therefore one term of an original and more general disjunction.

\paragraph{Corollary 2 (Against objectified absolutes).}
For all that one names it (absolute, I) and separates it from being, if one
objectifies it and separates it from oneself, then it is the same old thing in
itself.

\paragraph{Thesis 7 (Neither term is absolute oneness).}
Thus absolute oneness can no more reside in being than in its correlative
consciousness. It can be as little posited in the thing as in the
representation of the thing.

\paragraph{Definition 3 (Pure knowing).}
Rather it resides in the principle of the absolute oneness and indivisibility of
both, which is equally the principle of their disjunction. This is the
principle of pure knowing, knowing in itself: completely objectless knowing;
because otherwise it would not be knowing in itself but would require
objectivity for its being.

\paragraph{Corollary 3 (Being presupposes thought).}
Absolutely all being presupposes a thought or consciousness having that being as
its object. Consequently being is a term of a disjunction, the other half of
which is thinking.

\paragraph{Thesis 8 (Oneness as certainty).}
For this reason oneness is not to be found in the one or the other but in the
connection of both. Oneness thus is the same as pure knowing in and for itself
and therefore it is knowledge of nothing. Oneness is found in truth and
certainty, which is not certainty about any particular thing, since in that case
the disjunction of being and thinking is already posited in it.

\subsection*{Transcendental Philosophy}
...
\subsection*{Critical Philosophy}

\subsubsection*{The System of the Transcendental Ideas}
...
\begin{enumerate}
\item the relation to the subject,
\item the relation to objects (either as appearances or as objects of thinking in general).
\end{enumerate}
...
\begin{enumerate}
\item the relation to the subject,
\item the manifold of the object in appearance, and
\item to all things in general.
\end{enumerate}
...
\subsubsection*{Three Kinds of Antinomy of Pure Reason}
...
compensation for these losses an all the greater employment opens up for
a practical respect; it seems unable to depart from those hopes to free itself
...
for then reason, insofar as it judges concerning these principles,
unremittingly demands with regard to all of them the unconditioned
for the given conditions, which however can never be found if one considers
the sensible as belonging to things in themselves
rather than ascribing to it, as mere appearance, something supersensible:
the intelligible substratum of nature outside as well as within us.
...
for the faculty of cognition and then to the mode of reason with regard
...
we've already shown elsewhere their \emph{unavoidability}
if judgments of this kind do not look back to a supersensible substratum
of the given objects, as appearances, but also their \emph{resolvability}
...
there is no other means for avoiding it than
\emph{either} to deny that the
aesthetic judgment of taste is grounded on any principal a priori,
so that all claim to the necessity of universal assent is a
groundless, empty delusion, and a judgment of taste deserves to be held to be
correct only insofar as it \emph{happens} that many people agree about it,
and even this, strictly speaking, not because once one suspects an a priori
principle behind their consensus, but rather (as in the taste of the palate)
because the subjects are contingently organized in the same way;
\emph{or} one must assume that the judgment of taste is really a concealed
judgment of reason about the perfection that is revealed anything in a relation
of the manifold in it to the end, so that it is called aesthetic only on account
...
\paragraph{Remark (Kant; Dialectic of Taste, Remark 2: the supersensible).}
The resolution of the antinomy in the use of the power of judgment requires
that judgments of taste look back to a \emph{supersensible substratum} of the
given objects (as appearances): an \emph{intelligible substratum} (something
...
even if it has not been made clear enough in every detail, then three ideas
are revealed:
\begin{enumerate}
\item the supersensible in general, without further determination, as the substratum of nature;
\item the very same thing as the principle of the subjective purposiveness of nature for our faculty of cognition;
\item the very same thing as the principle of the ends of freedom and principle of the correspondence of freedom with those ends in the moral sphere.
\end{enumerate}

\paragraph{Crosswalk (interpretive; Sāṃkhya).}
Read with precision: the foregoing threefold disclosure can be mapped (as a
\emph{crosswalk}, not as a historical claim about Kant) into a Sāṃkhyan triad.

\begin{enumerate}
\item Nature as lawful appearing (\emph{substratum of nature}) $\leadsto$ \emph{Prakṛti}.
\item Spirit/freedom as practical unconditioned (\emph{ends of freedom}) $\leadsto$ \emph{Puruṣa}.
\item The mediating principle that makes their relation legible (\emph{subjective purposiveness} and the appeal to a common root) $\leadsto$ \emph{Buddhi} (as discriminative/mediating intellect).
\end{enumerate}

\paragraph{Thesis (Non-genetic vs. genetic).}
On this reading, Kant arrives at a threefold \emph{standing articulation} of Nature,
Spirit, and the mediating principle ("in supreme enlightenment" as disclosed
standpoints), but does not yet perform the \emph{genetic derivation} of their oneness.
The Science of Knowing takes this as the decisive task: to render the unity
actively genetic (not merely posited as a necessary connection).
See the first-week Prolegomena in \texttt{gds/doc/prolegomena-fichte.tex}.

\subsubsection*{Architectonic of Pure Reason}
...
only the rational cognition of this is here meant.
...
\subsubsection*{Kant and the Remaining Duality (Science of Knowing vs. Kantian Transcendentalism)}
...
but rather only as a common basic determination or accident of its three primordial modes.
...
and thus the second absolute ($z$) is the moral world.
...
Examining sequentially the memory of inner experience
