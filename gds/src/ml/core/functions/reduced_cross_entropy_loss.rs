//! Reduced cross entropy loss function for ML in GDS.
//!
...
///
/// Corresponds to ReducedCrossEntropyLoss in Java GDS.
...
impl ReducedCrossEntropyLoss {
    ...
    fn compute_error_per_example(
        ...
        _predicted_probability_for_true_class: f64,
        true_class: usize,
    ) -> f64 {
        self.class_weights[true_class] * (predicted_class_probability - indicator_is_true_class)
...
impl Variable for ReducedCrossEntropyLoss {
...
impl fmt::Display for ReducedCrossEntropyLoss {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "ReducedCrossEntropyLoss")
    }
}
