use super::modes;
use super::request::KSpanningTreeRequest;
...
pub fn handle_kspanningtree(request: &Value, catalog: Arc<dyn GraphCatalog>) -> Value {
    ...
    let parsed = match KSpanningTreeRequest::parse(request) {
        Ok(r) => r,
    ...
    match parsed.common.mode {
        ...
        Mode::Mutate => err(op, "NOT_IMPLEMENTED", "KSpanningTree mutate is not implemented yet"),
        Mode::Write => err(op, "NOT_IMPLEMENTED", "KSpanningTree write is not implemented yet"),
    }
}
