use super::modes;
use super::request::AStarRequest;
...
pub fn handle_astar(request: &Value, catalog: Arc<dyn GraphCatalog>) -> Value {
    ...
    let parsed = match AStarRequest::parse(request) {
        Ok(r) => r,
    ...
    match parsed.common.mode {
        ...
        Mode::Mutate => err(op, "NOT_IMPLEMENTED", "A* mutate is not implemented yet"),
        Mode::Write => err(op, "NOT_IMPLEMENTED", "A* write is not implemented yet"),
    }
}
