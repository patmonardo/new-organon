use super::modes;
use super::request::RandomWalkRequest;
...
pub fn handle_random_walk(request: &Value, catalog: Arc<dyn GraphCatalog>) -> Value {
    ...
    let parsed = match RandomWalkRequest::parse(request) {
        Ok(r) => r,
    ...
    match parsed.common.mode {
        ...
        Mode::Mutate => err(op, "NOT_IMPLEMENTED", "RandomWalk mutate is not implemented yet"),
        Mode::Write => err(op, "NOT_IMPLEMENTED", "RandomWalk write is not implemented yet"),
    }
}
