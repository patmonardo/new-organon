...
pub fn handle_bfs(request: &Value, catalog: Arc<dyn GraphCatalog>) -> Value {
    ...
    let parsed = match BfsRequest::parse(request) {
        Ok(r) => r,
    ...
    match parsed.common.mode {
        ...
        Mode::Mutate => err(op, "NOT_IMPLEMENTED", "BFS mutate is not implemented yet"),
        Mode::Write => err(op, "NOT_IMPLEMENTED", "BFS write is not implemented yet"),
