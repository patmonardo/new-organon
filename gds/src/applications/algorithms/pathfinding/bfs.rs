    ...
    match mode {
        ...
        "stats" => {
            ...
            let builder = FnStatsResultBuilder(
                |_gr: &GraphResources, stats: Option<BfsStats>, timings| {
                    json!({
                        "ok": true,
                        "op": op,
                        "mode": "stats",
        ...
        "mutate" => err(op, "NOT_IMPLEMENTED", "BFS mutate is not implemented"),
        "write" => err(op, "NOT_IMPLEMENTED", "BFS write is not implemented"),
