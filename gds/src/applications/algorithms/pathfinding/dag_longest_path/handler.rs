use super::modes;
use super::request::DagLongestPathRequest;
...
pub fn handle_dag_longest_path(request: &Value, catalog: Arc<dyn GraphCatalog>) -> Value {
    ...
    let parsed = match DagLongestPathRequest::parse(request) {
        Ok(r) => r,
    ...
    match parsed.common.mode {
        ...
        Mode::Mutate => err(op, "NOT_IMPLEMENTED", "DagLongestPath mutate is not implemented yet"),
        Mode::Write => err(op, "NOT_IMPLEMENTED", "DagLongestPath write is not implemented yet"),
    }
}
