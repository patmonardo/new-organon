...
fn graphsage_train_then_infer_via_catalog() {
    ...
    let train_cfg = crate::procedures::embeddings::graphsage::types::GraphSageTrainConfig {
...
fn graphsage_memory_estimation_smoke() {
    ...
    let cfg = crate::procedures::embeddings::graphsage::types::GraphSageTrainConfig {
        model_user: "alice".to_string(),
        model_name: "m1".to_string(),
