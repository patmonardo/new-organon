//! HITS Pregel Facade - Bidirectional Pregel implementation

use crate::procedures::hits::pregel_computation::run_hits_pregel;
...
impl HitsPregelBuilder {
    ...
    pub fn stream(&self) -> Result<Vec<HitsPregelRow>, String> {
    ...
    pub fn stats(&self) -> Result<HitsPregelStats, String> {
