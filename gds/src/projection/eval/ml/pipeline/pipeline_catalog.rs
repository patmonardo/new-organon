...
use crate::projection::eval::ml::pipeline::TrainingPipeline;
...
mod tests {
    ...
    impl crate::projection::eval::ml::pipeline::FeatureStep for MockFeatureStep {
        fn name(&self) -> &str {
            "mock"
        }
    ...
    impl crate::projection::eval::ml::pipeline::Pipeline for MockPipeline {
    ...
    impl TrainingPipeline for MockPipeline {
        ...
        fn training_parameter_space(
            ...
            crate::projection::eval::ml::pipeline::TrainingMethod,
            Vec<Box<dyn crate::projection::eval::ml::pipeline::TunableTrainerConfig>>,
        > {
        ...
        fn auto_tuning_config(&self) -> &crate::projection::eval::ml::pipeline::AutoTuningConfig {
            use std::sync::OnceLock;
            static CONFIG: OnceLock<crate::projection::eval::ml::pipeline::AutoTuningConfig> =
                OnceLock::new();
            CONFIG.get_or_init(|| {
                crate::projection::eval::ml::pipeline::AutoTuningConfig::new(1).unwrap()
            })
        }

        fn set_auto_tuning_config(
            &mut self,
            _config: crate::projection::eval::ml::pipeline::AutoTuningConfig,
        ) {
