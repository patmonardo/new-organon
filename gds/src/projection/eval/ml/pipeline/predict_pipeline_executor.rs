...
mod tests {
    ...
    use crate::projection::eval::ml::pipeline::node_pipeline::NodeFeatureStep;
    ...
    fn test_predict_pipeline_executor_compute_smoke_runs_node_property_step() {
        ...
        struct SmokePipeline {
            node_property_steps:
                Vec<Box<dyn crate::projection::eval::ml::pipeline::ExecutableNodePropertyStep>>,
        ...
        config.insert(
            crate::projection::eval::ml::pipeline::MUTATE_PROPERTY_KEY.to_string(),
        ...
        let step = NodePropertyStep::new(
            crate::projection::eval::ml::pipeline::node_property_step::DEBUG_WRITE_CONSTANT_DOUBLE_MUTATE
                .to_string(),
            config,
        );
