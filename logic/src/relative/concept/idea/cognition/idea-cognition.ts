...
/**
 * CHAPTER 2: THE IDEA OF COGNITION — Introduction
 * 
 * NOTE: This is the introduction section of Chapter 2, before A. THE IDEA OF THE TRUE
 * 
 * Structure:
 * 1. Life and Cognition - judgment that doubles the idea
 * 2. Metaphysics of spirit and Kant's critique
 * 3. Hegel's critique of Kant's empty "I"
 * 4. Mendelssohn's proof and Kant's refutation
 * 5. Kant side-lining truth
 * 6. Idea of spirit emerging from life
 * 7. Concrete shapes of spirit (soul, consciousness, spirit)
 * 8. Logical idea of spirit
 * 9. Idea as purpose seeking truth
 * 10. Idea as syllogism
 * 11. Theoretical idea as cognition
 */
...
export const CANONICAL_CHUNKS: Chunk[] = [
  {
    id: 'cognition-intro-1-life-judgment',
    title: 'Life and cognition — judgment doubles the idea',
...
of its being, is its own difference from itself.`,
  ...
  {
    id: 'cognition-intro-2-metaphysics-kant',
    title: 'Metaphysics of spirit and Kant\'s critique',
    text: `The metaphysics of the spirit or,
...
independently of the things of space and time.`,
    summary: 'Metaphysics of spirit/soul: determinations of substance/simplicity/immateriality. Spirit as ground but subject from empirical consciousness. Procedure no further than physics, reduces appearance to laws/reflection. Spirit infinitely richer, absolute unity of opposites, exhibits contradiction. Predicates from appearances = empirical psychology. Kant: rational science requires no perception, only simple representation "I" = mere consciousness accompanying concepts. "I" = transcendental subject = x, known only through thoughts as predicates. Inconvenience: must use "I" to judge "I". Paralogism: modes of self-consciousness converted to concepts of understanding, "I think" = thinking being/thing-in-itself, illegitimate inference to substance/simple/one/concrete existence independent of space/time.'
  },
  {
    id: 'cognition-intro-3-hegel-critique-kant',
    title: 'Hegel\'s critique of Kant\'s empty "I"',
    text: `I have cited this position in some detail
...
something else outside it must shoulder that effort.`,
    summary: 'Former metaphysics: abstract essence of soul from observation, empirical generalizations, external reflection. Kant: metaphysics stayed at one-sided determinations, no dialectic, ignored speculative ideas. Humean skepticism: fixes on "I" appearance, removes empirical, leaves "I think" without concept. Without comprehending, no concept of "I" or anything. Laughable: "I" thinks itself = awkwardness/circle. But this awkwardness = eternal nature of self-consciousness/concept revealed in empirical self-consciousness. Self-consciousness = existent/empirically perceivable pure concept = absolute self-reference making itself into circle. Stone does not have this awkwardness.'
  },
  {
    id: 'cognition-intro-4-kant-objectivity',
    title: 'Kant\'s "I" and objectivity',
    text: `The defect, which these surely barbarous notions place
...
the untruth of that abstraction finds expression.`,
    summary: 'Defect: "I" cannot be left out as subject. Also: "I" only as subject of consciousness, no intuition as object. Thing existing only as subject = no objective reality. If objectivity = external intuition in time/space, then objectivity = sensuous reality. But rising above sensuous reality = condition of thinking/truth. "I" as mere representation = abstract self-determination, not self-reference. One-sided subject without objectivity OR object without subjectivity. But awkwardness already in "I" as subject - "I" thinks something. Inseparability of two forms ("I" opposes itself to itself) = intimate nature of concept. Kant wants to keep this away to retain representation void of concept. Conceptual void opposes abstract determinations, but lame compared to Aristotle\'s speculative ideas. Should have investigated empty "I" abstraction. Awkwardness = empirical fact showing untruth of abstraction.'
  },
  {
    id: 'cognition-intro-5-mendelssohn-kant',
    title: 'Mendelssohn\'s proof and Kant\'s refutation',
    text: `The Kantian critique of rational psychology
...
but on the contrary is sublated in the concept?`,
    summary: 'Mendelssohn\'s proof: soul\'s simplicity = incapable of alteration/transition. Qualitative simplicity = abstraction, dialectical, transition into other. Concept: concrete simplicity = unity of itself and other, eternal, cannot pass over (comes to itself). Kant opposes quantitative determination: soul = intensive magnitude, consciousness has degree, possibility of transition into nothing through gradual vanishing. Refutation = application of category of being (intensive magnitude) to spirit, determination sublated in concept.'
  },
  {
    id: 'cognition-intro-6-kant-truth',
    title: 'Kant side-lining truth',
    text: `Metaphysics even one that restricted itself
...
and the said "I" which is not supposed to be an object to itself.`,
    summary: 'Metaphysics: aim = cognition of truth, probed subject matter for truth/substance/phenomena. Kant\'s triumph: side-lines investigation with truth as aim, does not pose question whether abstract "I" has truth in and for itself. Staying at appearances/representations = giving up concept/philosophy. Beyond branded as high-flown. But concept does fly high, rising above what has no concept. Justification: concept itself + untruth of appearance/representation/thing-in-itself/empty "I".'
  },
  {
    id: 'cognition-intro-7-spirit-life',
    title: 'Idea of spirit emerging from life',
    text: `In the context of this logical exposition,
...
as soul, consciousness, and spirit as such.`,
    summary: 'From idea of life emerges idea of spirit = truth of life. Idea possesses truth in and for itself, compare with empirical reality/appearance. Life = idea but not true presentation. In life: reality = singularity, universality/genus = inwardness. Truth of life = absolute negative unity: sublate abstract/immediate singularity, be self-identical, genus = self-equal. This idea = spirit. Spirit here = logical form. Idea has other shapes: soul, consciousness, spirit as such (concrete sciences).'
  },
  {
    id: 'cognition-intro-8-soul-consciousness-spirit',
    title: 'Concrete shapes: soul, consciousness, spirit',
    text: `The name "soul" was used formerly to mean
...
and goes on to grasp its truth, the infinite spirit.`,
    summary: 'Soul: singular finite spirit, thing-like, seat/spatial location, imperishable yet temporal. Monads: matter = soul, atom-like, coffee vapor can become soul. Concept for itself = immediate existence, substantial identity with life = anthropology. Anthropology: obscure region, natural spirit, sympathy with nature, presentiments, indwells organs. Consciousness: free concept as "I" for itself, withdrawn from objectivity, refers to other. Immediacy = negative, identity = reflective shining, objectivity = being in itself. Phenomenology of spirit: midway between natural spirit and spirit as such, spirit appearing in contrary. Spirit for itself: subject matter = own determination/representation, acts on determinations as own, infinite. Doctrine of spirit proper: not empirical but scientific. Finite spirit: content immediately given, liberates to infinite spirit.'
  },
  {
    id: 'cognition-intro-9-logical-spirit',
    title: 'Logical idea of spirit',
    text: `The idea of spirit which is the subject matter of logic
...
Also in this shape, however, the idea is still not consummated.`,
    summary: 'Logical idea of spirit = pure science, no need to observe entanglement with nature/matter/representation (other sciences). Course already behind/ahead: behind if logic = final science, ahead if logic = first science (passes to nature). Logical "I" = emerged from concept of nature as truth of nature, free concept in judgment = subject matter confronting it, concept as idea. But idea still not consummated.'
  },
  {
    id: 'cognition-intro-10-idea-purpose',
    title: 'Idea as purpose seeking truth',
    text: `Although the idea is indeed the free concept
...
and, by thus giving itself its reality in the object, finds truth.`,
    summary: 'Idea = free concept with itself as subject matter, but immediate = idea in subjectivity/finitude. Purpose that ought to realize itself = absolute idea in appearance. Seeks truth = identity of concept and reality, but only seeks (still subjective). Subject matter given but does not affect subject, subject transforms into conceptual determination. Concept = active principle referring itself to itself, gives itself reality in object, finds truth.'
  },
  {
    id: 'cognition-intro-11-idea-syllogism',
    title: 'Idea as syllogism extremes',
    text: `Initially, therefore, the idea is one extreme of a syllogism,
...
as identical with objectivity.`,
    summary: 'Idea = one extreme of syllogism: concept as purpose with itself as subjective reality. Other extreme = restriction of subjective, objective world. Two extremes identical = idea. Unity: (1) concept - one extreme for itself, other in itself; (2) reality - one abstract, other concrete externality. Unity posited through cognition = subjective idea proceeding from itself = middle term. Knowing subject: determinateness = abstract being-for-itself, refers to external world, absolute certainty, elevates implicit reality/formal truth to real truth. Has entire essentiality of objective world in concept. Process: posits concrete reality as identical with concept, concept as identical with objectivity.'
  },
  {
    id: 'cognition-intro-12-theoretical-idea',
    title: 'Theoretical idea as cognition',
    text: `Immediately, the idea of appearance is
...
the content, is received by it from the outside.`,
    summary: 'Idea of appearance = theoretical idea = cognition. To concept for itself, objective world = immediacy/being. Concept = abstract concept of itself, shut up within itself. Concept = form only, simple determinations (universality/particularity) = reality within, singularity/determinate determinateness/content = received from outside.'
  },
];
...
export const LOGICAL_OPERATIONS: LogicalOperation[] = [
  {
    id: 'cognition-op-intro-1-life-judgment',
    chunkId: 'cognition-intro-1-life-judgment',
    label: 'Life and cognition — judgment doubles idea',
    clauses: [
      'life = immediateIdea',
    ...
    predicates: [
      ...
      { name: 'DoublesIdea', args: ['judgment'] },
    ],
    relations: [
  ...
  {
    id: 'cognition-op-intro-2-metaphysics-kant',
    chunkId: 'cognition-intro-2-metaphysics-kant',
    label: 'Metaphysics of spirit and Kant\'s critique',
    clauses: [
      'metaphysicsOfSpirit = determinationsOfSubstanceSimplicityImmateriality',
      'spirit = groundButSubjectFromEmpiricalConsciousness',
      'procedure.noFurtherThan = physics',
      'spirit.infinitelyRicher = nature',
      'spirit.essence = absoluteUnityOfOpposites',
      'spirit.exhibits = contradiction',
      'kant.requires = noPerception',
      'kant.leaves = simpleRepresentationI',
      'simpleRepresentationI = mereConsciousness',
      'I = transcendentalSubject',
      'I.knownOnlyThrough = thoughtsAsPredicates',
      'I.inconvenience = mustUseItoJudgeI',
      'paralogism = modesOfSelfConsciousnessConvertedToConcepts',
      'paralogism = IThinkTakenAsThingInItself',
      'illegitimateInference = substanceSimpleOneConcreteExistence',
    ],
    predicates: [
      { name: 'IsParalogism', args: ['rationalPsychology'] },
      { name: 'IsTranscendentalSubject', args: ['I'] },
    ],
    relations: [
      { predicate: 'leadsTo', from: 'metaphysicsOfSpirit', to: 'paralogism' },
      { predicate: 'is', from: 'I', to: 'transcendentalSubject' },
    ],
  },
  {
    id: 'cognition-op-intro-3-hegel-critique-kant',
    chunkId: 'cognition-intro-3-hegel-critique-kant',
    label: 'Hegel\'s critique of Kant\'s empty "I"',
    clauses: [
      'formerMetaphysics = abstractEssenceFromObservation',
      'kant.metaphysics = oneSidedDeterminations',
      'kant.noDialectic = true',
      'kant.ignored = speculativeIdeas',
      'kant.abidedBy = humeanSkepticism',
      'kant.removes = everythingEmpirical',
      'kant.leaves = appearanceOfIThink',
      'withoutComprehending.noConcept = true',
      'IthinksItself = awkwardness',
      'butAwkwardness = eternalNatureOfSelfConsciousness',
      'selfConsciousness = existentPureConcept',
      'selfConsciousness = absoluteSelfReference',
      'selfConsciousness = circle',
      'stone.noAwkwardness = true',
    ],
    predicates: [
      { name: 'IsEmpty', args: ['kantI'] },
      { name: 'IsEternalNature', args: ['selfConsciousness'] },
    ],
    relations: [
      { predicate: 'reveals', from: 'awkwardness', to: 'eternalNatureOfSelfConsciousness' },
      { predicate: 'is', from: 'selfConsciousness', to: 'absoluteSelfReference' },
    ],
  },
  {
    id: 'cognition-op-intro-4-kant-objectivity',
    chunkId: 'cognition-intro-4-kant-objectivity',
    label: 'Kant\'s "I" and objectivity',
    clauses: [
      'I.onlyAsSubject = true',
      'I.noIntuitionAsObject = true',
      'objectivity.requires = externalIntuitionInTimeSpace',
      'objectivity = sensuousReality',
      'risingAboveSensuousReality = conditionOfThinkingTruth',
      'IasMereRepresentation = abstractSelfDetermination',
      'IasMereRepresentation.notSelfReference = true',
      'I = oneSidedSubjectWithoutObjectivity',
      'inseparabilityOfTwoForms = intimateNatureOfConcept',
      'kant.wantsToKeepAway = inseparability',
      'kant.retains = representationVoidOfConcept',
      'conceptualVoid.lameComparedTo = aristotleSpeculativeIdeas',
      'shouldHaveInvestigated = emptyIAbstraction',
      'awkwardness = empiricalFactShowingUntruth',
    ],
    predicates: [
      { name: 'IsVoidOfConcept', args: ['kantRepresentation'] },
      { name: 'ShowsUntruth', args: ['awkwardness'] },
    ],
    relations: [
      { predicate: 'belongsTo', from: 'inseparabilityOfTwoForms', to: 'intimateNatureOfConcept' },
      { predicate: 'shows', from: 'awkwardness', to: 'untruthOfAbstraction' },
    ],
  },
  {
    id: 'cognition-op-intro-5-mendelssohn-kant',
    chunkId: 'cognition-intro-5-mendelssohn-kant',
    label: 'Mendelssohn\'s proof and Kant\'s refutation',
    clauses: [
      'mendelssohnProof = simplicityOfSoul',
      'simplicityOfSoul = incapableOfAlteration',
      'qualitativeSimplicity = abstraction',
      'qualitativeSimplicity = dialectical',
      'qualitativeSimplicity = transitionIntoOther',
      'concept = concreteSimplicity',
      'concept = unityOfItselfAndOther',
      'concept.eternal = true',
      'concept.cannotPassOver = true',
      'kant.opposes = quantitativeDetermination',
      'kant.soul = intensiveMagnitude',
      'kant.consciousness.hasDegree = true',
      'kant.possibility = transitionIntoNothing',
      'refutation = applicationOfCategoryOfBeing',
      'intensiveMagnitude.sublatedInConcept = true',
    ],
    predicates: [
      { name: 'IsConcreteSimplicity', args: ['concept'] },
      { name: 'IsSublated', args: ['intensiveMagnitude'] },
    ],
    relations: [
      { predicate: 'opposes', from: 'kant', to: 'qualitativeDetermination' },
      { predicate: 'is', from: 'refutation', to: 'applicationOfCategoryOfBeing' },
    ],
  },
  {
    id: 'cognition-op-intro-6-kant-truth',
    chunkId: 'cognition-intro-6-kant-truth',
    label: 'Kant side-lining truth',
    clauses: [
      'metaphysics.aim = cognitionOfTruth',
      'metaphysics.probed = truthSubstancePhenomena',
      'kant.sideLined = investigationWithTruthAsAim',
      'kant.doesNotPose = questionOfTruth',
      'stayingAtAppearances = givingUpConceptPhilosophy',
      'beyondBrandedAs = highFlown',
      'concept.fliesHigh = true',
      'concept.risesAbove = whatHasNoConcept',
      'justification = conceptItself',
      'justification = untruthOfAppearance',
    ],
    predicates: [
      { name: 'SideLinedTruth', args: ['kantCritique'] },
      { name: 'FliesHigh', args: ['concept'] },
    ],
    relations: [
      { predicate: 'sideLined', from: 'kantCritique', to: 'investigationOfTruth' },
      { predicate: 'risesAbove', from: 'concept', to: 'whatHasNoConcept' },
    ],
  },
  {
    id: 'cognition-op-intro-7-spirit-life',
    chunkId: 'cognition-intro-7-spirit-life',
    label: 'Idea of spirit emerging from life',
    clauses: [
      'ideaOfSpirit.emergedFrom = ideaOfLife',
      'ideaOfSpirit = truthOfLife',
      'idea.possessesTruth = inAndForItself',
      'life = ideaButNotTruePresentation',
      'inLife.reality = singularity',
      'inLife.universality = inwardness',
      'truthOfLife = absoluteNegativeUnity',
      'truthOfLife = sublateAbstractSingularity',
      'truthOfLife = beSelfIdentical',
      'truthOfLife = genusSelfEqual',
      'thisIdea = spirit',
      'spirit.here = logicalForm',
      'idea.hasOtherShapes = true',
      'otherShapes = {soul, consciousness, spiritAsSuch}',
    ],
    predicates: [
      { name: 'IsTruthOf', args: ['ideaOfSpirit', 'ideaOfLife'] },
      { name: 'IsAbsoluteNegativeUnity', args: ['truthOfLife'] },
    ],
    relations: [
      { predicate: 'emergesFrom', from: 'ideaOfSpirit', to: 'ideaOfLife' },
      { predicate: 'is', from: 'truthOfLife', to: 'spirit' },
    ],
  },
  {
    id: 'cognition-op-intro-8-soul-consciousness-spirit',
    chunkId: 'cognition-intro-8-soul-consciousness-spirit',
    label: 'Concrete shapes: soul, consciousness, spirit',
    clauses: [
      'soul = singularFiniteSpirit',
      'soul.evokesImage = thingLikeOtherThings',
      'soul.hasSeat = true',
      'monads.matter = soul',
      'soul = atomLike',
      'conceptForItself = immediateExistence',
      'conceptForItself = substantialIdentityWithLife',
      'conceptForItself = anthropology',
      'consciousness = freeConceptAsI',
      'consciousness.withdrawnFrom = objectivity',
      'consciousness.refersTo = other',
      'consciousness.immediacy = negative',
      'consciousness.identity = reflectiveShining',
      'consciousness = phenomenologyOfSpirit',
      'spiritForItself = infinite',
      'spiritForItself.subjectMatter = ownDetermination',
      'spiritForItself = doctrineOfSpiritProper',
      'spiritForItself.notEmpirical = true',
      'spiritForItself = scientific',
      'finiteSpirit.content = immediatelyGiven',
      'finiteSpirit.liberatesTo = infiniteSpirit',
    ],
    predicates: [
      { name: 'IsThingLike', args: ['soul'] },
      { name: 'IsInfinite', args: ['spiritForItself'] },
    ],
    relations: [
      { predicate: 'is', from: 'soul', to: 'lowestConcreteShape' },
      { predicate: 'is', from: 'consciousness', to: 'middleStage' },
      { predicate: 'is', from: 'spiritForItself', to: 'higherTruth' },
    ],
  },
  {
    id: 'cognition-op-intro-9-logical-spirit',
    chunkId: 'cognition-intro-9-logical-spirit',
    label: 'Logical idea of spirit',
    clauses: [
      'logicalIdeaOfSpirit = pureScience',
      'logicalIdeaOfSpirit.noNeedToObserve = entanglement',
      'logicalIdeaOfSpirit.courseBehind = ifLogicFinal',
      'logicalIdeaOfSpirit.courseAhead = ifLogicFirst',
      'logicalI = emergedFromConceptOfNature',
      'logicalI = truthOfNature',
      'logicalI = freeConcept',
      'logicalI.inJudgment = subjectMatterConfrontingIt',
      'logicalI = conceptAsIdea',
      'idea.stillNotConsummated = true',
    ],
    predicates: [
      { name: 'IsPureScience', args: ['logicalIdeaOfSpirit'] },
      { name: 'IsNotConsummated', args: ['idea'] },
    ],
    relations: [
      { predicate: 'is', from: 'logicalIdeaOfSpirit', to: 'pureScience' },
      { predicate: 'emergesFrom', from: 'logicalI', to: 'conceptOfNature' },
    ],
  },
  {
    id: 'cognition-op-intro-10-idea-purpose',
    chunkId: 'cognition-intro-10-idea-purpose',
    label: 'Idea as purpose seeking truth',
    clauses: [
      'idea = freeConcept',
      'idea.hasItselfAs = subjectMatter',
      'idea.immediate = true',
      'idea.immediate = subjectivity',
      'idea.immediate = finitude',
      'idea = purposeOughtToRealize',
      'idea = absoluteIdeaInAppearance',
      'idea.seeks = truth',
      'truth = identityOfConceptAndReality',
      'idea.onlySeeks = true',
      'idea.stillSubjective = true',
      'subjectMatter.given = true',
      'subjectMatter.doesNotAffect = subject',
      'subject.transforms = conceptualDetermination',
      'concept = activePrinciple',
      'concept.refersItselfToItself = true',
      'concept.givesItselfReality = inObject',
      'concept.findsTruth = true',
    ],
    predicates: [
      { name: 'SeeksTruth', args: ['idea'] },
      { name: 'IsActivePrinciple', args: ['concept'] },
    ],
    relations: [
      { predicate: 'seeks', from: 'idea', to: 'truth' },
      { predicate: 'gives', from: 'concept', to: 'realityInObject' },
    ],
  },
  {
    id: 'cognition-op-intro-11-idea-syllogism',
    chunkId: 'cognition-intro-11-idea-syllogism',
    label: 'Idea as syllogism extremes',
    clauses: [
      'idea = oneExtremeOfSyllogism',
      'oneExtreme = conceptAsPurpose',
      'oneExtreme.hasItselfAs = subjectiveReality',
      'otherExtreme = restrictionOfSubjective',
      'otherExtreme = objectiveWorld',
      'twoExtremes.identical = idea',
      'unity.first = concept',
      'unity.oneExtreme = forItself',
      'unity.otherExtreme = inItself',
      'unity.second = reality',
      'unity.oneExtreme = abstract',
      'unity.otherExtreme = concreteExternality',
      'unity.positedThrough = cognition',
      'cognition = subjectiveIdea',
      'cognition.proceedsFromItself = true',
      'cognition = middleTerm',
      'knowingSubject.determinateness = abstractBeingForItself',
      'knowingSubject.refersTo = externalWorld',
      'knowingSubject.absoluteCertainty = true',
      'knowingSubject.elevates = implicitRealityToRealTruth',
      'knowingSubject.hasEntireEssentiality = objectiveWorld',
      'process = positsConcreteRealityAsIdenticalWithConcept',
      'process = positsConceptAsIdenticalWithObjectivity',
    ],
    predicates: [
      { name: 'IsSyllogismExtreme', args: ['idea'] },
      { name: 'IsMiddleTerm', args: ['cognition'] },
    ],
    relations: [
      { predicate: 'is', from: 'idea', to: 'oneExtremeOfSyllogism' },
      { predicate: 'is', from: 'cognition', to: 'middleTerm' },
      { predicate: 'posits', from: 'process', to: 'identityOfConceptAndReality' },
    ],
  },
  {
    id: 'cognition-op-intro-12-theoretical-idea',
    chunkId: 'cognition-intro-12-theoretical-idea',
    label: 'Theoretical idea as cognition',
    clauses: [
      'ideaOfAppearance = theoreticalIdea',
      'theoreticalIdea = cognition',
      'toConceptForItself.objectiveWorld = immediacy',
      'toConceptForItself.objectiveWorld = being',
      'concept = abstractConceptOfItself',
      'concept.shutUpWithinItself = true',
      'concept = formOnly',
      'concept.simpleDeterminations = universalityParticularity',
      'concept.realityWithin = universalityParticularity',
      'concept.singularity = receivedFromOutside',
      'concept.content = receivedFromOutside',
    ],
    predicates: [
      { name: 'IsTheoreticalIdea', args: ['ideaOfAppearance'] },
      { name: 'ReceivesFromOutside', args: ['concept', 'singularity'] },
    ],
    relations: [
      { predicate: 'is', from: 'ideaOfAppearance', to: 'theoreticalIdea' },
      { predicate: 'receives', from: 'concept', to: 'singularityFromOutside' },
    ],
  },
];
