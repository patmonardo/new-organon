 ...
 * (dharma) - the form/formless oscillation.
 */
export const lawTopicMap: TopicMapEntry[] = [
  {
    id: "law-1",
    title: "Appearance — essence in concrete existence",
    lineRange: { start: 6, end: 24 },
