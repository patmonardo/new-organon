...
export const determinateTopicMap: TopicMapEntry[] = [
  ...
  },
  {
    ...
    keyPoints: [
      "Determinate content considered from two sides: as ground and as grounded",
      "Ground is itself moment of form as what is posited by it",
      "Each side is just as much ground as posited",
      "Each is whole mediation or whole form",
      "Form and content are one and same identity"
    ]
  },
  {
    id: "det-4",
    title: "Ground is sufficient — formal ground",
    lineRange: { start: 78, end: 103 },
    description: "Because of identity of ground and grounded, according both to content and form, ground is sufficient. Nothing in grounded which is not in ground. When one asks for ground, expects to see same determination doubled: once as posited, again as existence reflected into itself. In determined ground, ground and grounded are each whole form, content is one and same. Two sides do not have real determination, do not have different content. Determinateness is only one simple determinateness. Determinate ground present only in pure form, as formal ground. Content is self-identical content indifferent to form. Form is external to it, content is other than form.",
    keyPoints: [
      "Ground is sufficient, nothing in grounded which is not in ground",
      "Same determination doubled: as posited and as existence reflected into itself",
      "Two sides do not have real determination, do not have different content",
      "Determinate ground present only in pure form, as formal ground",
      "Content is self-identical content indifferent to form"
    ]
  },
  {
    id: "det-5",
    title: "b. Real ground — diverse content",
    lineRange: { start: 107, end: 133 },
    description: "Determinateness of ground is determinateness of substrate or content determination, and otherness in ground-connection itself, distinctness of content and form. Connection strays in content as external form, content indifferent to determinations. But two are not external to each other. Content is: identity of ground with itself in grounded, and of grounded in ground. Each side is identity of whole within it. But since they belong to form and constitute its determinate difference, each is in its determinateness identity of whole with itself. Consequently, each has diverse content as against other. Content essentially possesses difference of form within. Is as ground something other than what it is as grounded.",
    keyPoints: [
      "Determinateness of ground is determinateness of substrate and otherness in ground-connection",
      "Content is identity of ground with itself in grounded",
      "Each side is identity of whole within it",
      "Each has diverse content as against other",
      "Content essentially possesses difference of form within"
    ]
  },
  {
    id: "det-6",
    title: "Ground realized — no longer tautology",
    lineRange: { start: 135, end: 142 },
    description: "Moment ground and grounded have diverse content, ground-connection has ceased to be formal one. Turning back to ground and procession forward from ground to posited is no longer tautology. Ground is realized. Henceforth, when we ask for ground, we actually demand another content determination for it than determination of content whose ground we are asking for.",
    keyPoints: [
      "Ground and grounded have diverse content",
      "Ground-connection has ceased to be formal",
      "No longer tautology, ground is realized",
      "We demand another content determination for ground"
    ]
  },
  {
    id: "det-7",
    title: "Connection determines itself — twofold content",
    lineRange: { start: 144, end: 163 },
    description: "Connection determines itself further. Two sides are of different content, indifferent to each other. Each is immediate, self-identical determination. Ground reflects itself in other, back to itself. Content on side of ground is equally in grounded. Latter has self-identity and subsistence only in ground. But grounded also possesses content of its own. Is unity of twofold content. Unity is negative unity, but since determinations are indifferent, unity is only empty reference to each other, void of content, not their mediation. It is something externally holding them together.",
    keyPoints: [
      "Two sides are of different content, indifferent to each other",
      "Ground reflects itself in other, back to itself",
      "Grounded possesses content of its own, is unity of twofold content",
      "Unity is only empty reference, void of content, not their mediation",
      "Something externally holding them together"
    ]
  },
  {
    id: "det-8",
    title: "Real grounding connection — twofold",
    lineRange: { start: 165, end: 205 },
    description: "In real grounding connection there is present a twofold. For one thing, content determination which is ground extends continuously into positedness. Constitutes simple identity of ground and grounded. Grounded contains ground fully within itself. Connection is undifferentiated essential compactness. Anything else in grounded added is only unessential form, external determinations free from ground, immediate manifold. Unessential is positively identical element, indifferent positive substrate. For another thing, that linked with substrate is indifferent content, but as unessential side. Main thing is connection of substrate and unessential manifold. But this connection is also not ground. One of something that constitutes connection is not reference of form but only external tie. It too is only substrate.",
    keyPoints: [
      "Content determination which is ground extends continuously into positedness",
      "Grounded contains ground fully within itself",
      "Anything else is only unessential form, immediate manifold",
      "Unessential is indifferent positive substrate",
      "Connection is not ground, only external tie, only substrate"
    ]
  },
  {
    id: "det-9",
